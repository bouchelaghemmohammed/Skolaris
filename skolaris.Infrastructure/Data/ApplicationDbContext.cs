...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cours>(entity =>
        {
            ...
            entity.Property(e => e.Nom).HasMaxLength(200).IsRequired();
            entity.HasOne(e => e.Programme).WithMany(e => e.Cours).HasForeignKey(e => e.IdProgramme);
            entity.HasOne(e => e.Niveau).WithMany(e => e.Cours).HasForeignKey(e => e.IdNiveau);
        });
        ...
        // PaiementEleve — paiement de scolarité par session
        modelBuilder.Entity<PaiementEleve>(entity =>
        {
            ...
            entity.HasOne(e => e.Eleve)
                  ...
                  .HasForeignKey(e => e.IdEleve);
            entity.HasOne(e => e.Session)
                  .WithMany(e => e.PaiementsEleves)
                  .HasForeignKey(e => e.IdSession);
        });
 
        // TauxHoraireEnseignant — historique des taux horaires
        modelBuilder.Entity<TauxHoraireEnseignant>(entity =>
        {
            ...
            entity.HasOne(e => e.Enseignant)
                  .WithMany(e => e.TauxHoraires)
                  .HasForeignKey(e => e.IdEnseignant);
        });
 
        // PaiementEnseignant — paie calculée par session (heures × taux)
        modelBuilder.Entity<PaiementEnseignant>(entity =>
        {
            ...
            entity.HasOne(e => e.Enseignant)
                  ...
                  .HasForeignKey(e => e.IdEnseignant);
            entity.HasOne(e => e.Session)
                  .WithMany(e => e.PaiementsEnseignants)
                  .HasForeignKey(e => e.IdSession);
            entity.HasOne(e => e.TauxHoraire)
                  .WithMany(e => e.Paiements)
                  .HasForeignKey(e => e.IdTaux);
        });
    }
}
